...
class CyclecountModeDayModel(models.Model):
    ...
    goods_code = models.CharField(max_length=255, verbose_name="Goods Code")
    goods_qty = models.BigIntegerField(default=0, verbose_name="On Hand Stock")
    physical_inventory = models.BigIntegerField(default=0, verbose_name="Physical Inventory")  # DB-008 / ISS-033: Fixed verbose_name
    difference = models.BigIntegerField(default=0, verbose_name="Difference")  # DB-008 / ISS-033: Fixed verbose_name
    creater = models.CharField(max_length=255, verbose_name="Who Create")
