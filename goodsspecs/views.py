...
class APIViewSet(viewsets.ModelViewSet):
    ...
    def get_serializer_class(self):
        if self.action in ['list', 'retrieve', 'destroy']:
            ...
            return serializers.GoodsspecsPostSerializer
        elif self.action in ['update']:
            return serializers.GoodsspecsUpdateSerializer
        elif self.action in ['partial_update']:
            return serializers.GoodsspecsPartialUpdateSerializer
        else:
    ...
    def create(self, request, *args, **kwargs):
        ...
        if ListModel.objects.filter(openid=data['openid'], goods_specs=data['goods_specs'], is_delete=False).exists():
