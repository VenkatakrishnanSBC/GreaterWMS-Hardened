...
from django.db import transaction  # DB-001

logger = logging.getLogger(__name__)  # CODE-008
...
class StockBinViewSet(viewsets.ModelViewSet):
    ...
    @transaction.atomic  # DB-001: Ensure all stock changes are atomic
    def create(self, request, pk):
        ...
        if qs.openid != self.request.auth.openid:
            ...
            if 'bin_name' not in data and 'move_to_bin' not in data:
                ...
                # DB-006: select_for_update prevents concurrent stock corruption
